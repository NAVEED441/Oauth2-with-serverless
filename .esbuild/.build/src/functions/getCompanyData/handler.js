...
// src/functions/getCompanyData/handler.ts
__export(exports, {
  main: () => main
});
...
var getCompanydata = async (event) => {
  const { token } = event.pathParameters;
  console.log("============================");
  console.log({ token });
  console.log("============================");
  const response = await axios.get("https://sandbox-quickbooks.api.intuit.com/v3/company/4620816365207026120/account/93?minorversion=62", {
    headers: {
...
var main = middyfy(getCompanydata);
