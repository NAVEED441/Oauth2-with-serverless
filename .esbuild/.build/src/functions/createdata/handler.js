...
// src/functions/createdata/handler.ts
__export(exports, {
  main: () => main
});
...
var createdatda = async () => {
  const response = await axios.post("https://sandbox-quickbooks.api.intuit.com/v3/company/4620816365207026120/account?minorversion=62", {
    Name: "MyJobs_test4546464646546",
