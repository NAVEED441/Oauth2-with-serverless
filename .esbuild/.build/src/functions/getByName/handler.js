...
// src/functions/getByName/handler.ts
__export(exports, {
  main: () => main
});
...
var getByname = async (event) => {
  const { token } = event.pathParameters;
  console.log("============================");
  console.log({ token });
  console.log("============================");
  const response = await axios.get("https://sandbox-quickbooks.api.intuit.com/v3/company/4620816365207026120/query?query= select * from Account where Name > 'naveedkha123'&minorversion=62", {
    headers: {
